...
def project_image(proj, targets, png_prefix, num_snapshots):
    png_prefix_path = Path(png_prefix)
    if not png_prefix_path.exists():
        png_prefix_path.mkdir()
...
Run 'python %(prog)s <subcommand> --help' for subcommand help.''',
    ...
    func_name_map = {
        'project-generated-images': 'epoching_custom_run_projector.project_generated_images',
        'project-real-images': 'epoching_custom_run_projector.project_real_images'
    }
